...
public class ConditionalStatementExample {
	public static void main(String[] args) {
		...
		if(score < 90) 
			System.out.println("점수가 90보다 작습니다."); //1줄정도는 괄호없이 실행가능함
			System.out.println("등급은 B입니다."); //그 이후는 별개의 줄. 들여쓰기때문에 그렇게 보이는것임
		 ...
		 */
		 ...
		 } //break;없으면 밑으로 다 나와버림
		 
		 //char 타입의 switch문. 대소문자때문에 의도적으로 break뺄때도 있음
